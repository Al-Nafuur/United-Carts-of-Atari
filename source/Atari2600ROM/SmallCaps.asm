...
;    CHAR_R Wifi, %0011, %0011, %0000, %0000, %0011, %0011, %0000, %0000, %0010, %0010, %0011, %0011
    ...
    CHAR_D Wifi1,        %0000, %0000, %0000, %1000, %1000, %1100, %0100, %0100, %0100, %0100, %0100, %0100
    CHAR_D Wifi2,        %0000, %1110, %1111, %0001, %0000, %1100, %1110, %0011, %0001, %1101, %1101, %1101
    CHAR_L NoWifi1,      %0000, %0000, %0000, %0000, %0000, %0000, %0000, %0000, %0000, %0000, %0000, %0000
    CHAR_R NoWifi2,      %0000, %0000, %0000, %0000, %0000, %1100, %1110, %0010, %0001, %1101, %1101, %1101
